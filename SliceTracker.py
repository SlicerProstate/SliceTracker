...
from SliceTrackerUtils.helpers import SmartDICOMReceiver, SliceAnnotation
from SliceTrackerUtils.helpers import RatingWindow, IncomingDataMessageBox, CustomTargetTableModel
...
class SliceTrackerWidget(ScriptedLoadableModuleWidget, ModuleWidgetMixin, SliceTrackerConstants):
  ...
  def displayRegistrationResults(self, registrationType):
    for targets in [targets for targets in self.currentResult.targets.values() if targets]:
